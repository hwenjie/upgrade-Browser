      ...
      '<div class="anti-ie-dialog" id="anti-ie-dialog">',
        '<div class="anti-ie-text">',
          ...
          '<div class="anti-ie-para">',
            '<a class="anti-ie-browser-link" href="http://browser.360.cn/se/" target="_blank" hidefocus>',
        ...
        '<div class="anti-ie-btn-ctnr">',
          ...
          '<a class="anti-ie-btn" id="anti-ie-try-new" href="http://browser.360.cn/se/" target="_blank">下载360安全浏览器</a>',
        '</div>',
      '</div>',
    '</div>'
  ].join('');
